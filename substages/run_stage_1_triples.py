"""
SemanticPrism Stage 1: Triple Extraction & Aggregation Script
This standalone script initializes the Stage 1 pipeline for triples, loads the central config,
...
from src.agents.extraction_agents import triple_model
...
def main():
    ...
    print(f"=== Phase 3: Global Triple Extraction (Model: {triple_model}) ===")
    ...
    print("\nStage 1 Triple Extraction Complete!")
